...
MEASUREMENT_RE = re.compile(
    ...
    r".* counter:mcycle.* architecture:(\S+) backend:(\S+)"
)
...
def main():
    ...
    print()
    print(
        "Cycle counts come from the `mcycle` CSR and are reported in thousands. "
        "Retired instructions are also present in the canonical target evidence."
    )
