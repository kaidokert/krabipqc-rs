...
| ML-DSA-44 sign    |        16.5 KiB |       80 204 B  |    20.3 KiB  |    80 196 B  |
| ML-KEM-512 decaps |        17.8 KiB |       28 156 B  |    21.7 KiB  |    28 116 B  |

Sign stack holds NTT-domain intermediate vectors live across the rejection loop.
The `lowmem` feature trades ~15% of that for extra re-computation on each retry.
